...
namespace StockRankTracker.Services.Crawlers;

/// <summary>
/// 成交金額排行爬蟲（實作 IRankCrawler）
/// 從 Yahoo 股市抓取成交金額排行資料
/// </summary>
public class TurnoverCrawler : IRankCrawler
{
    private const string Url = "https://tw.stock.yahoo.com/rank/turnover";
    private readonly HttpClient _client;

    public TurnoverCrawler(HttpClient client)
    {
        _client = client;
    }
